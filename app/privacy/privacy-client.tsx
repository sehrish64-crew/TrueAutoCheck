    ...
    <div className="bg-white">
      <div className="relative container mx-auto px-6 py-20">
        ...
        <div className="mt-10 space-y-8 max-w-3xl mx-auto text-gray-700">
          <section>
            <p className="text-lg font-semibold text-gray-900 mb-4">Grace Global Ltd, operating trueautocheck.com, is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website and use our services.</p>
