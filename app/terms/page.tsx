        ...
        <div className="mt-10 space-y-8 max-w-3xl mx-auto text-gray-700">
          ...
          <section>
            ...
            {/* <div className="mt-6 bg-blue-50 p-4 rounded-lg border border-blue-200">
              ...
              <p className="text-sm text-gray-700 mb-2">Refund requests may be submitted within 14 days of purchase if any of the following apply:</p>
              <ul className="text-sm text-gray-700 space-y-1 list-disc list-inside ml-2">
                <li>The report was not delivered within the stated delivery timeframe.</li>
                <li>A technical issue prevented access to the report.</li>
                <li>An accidental duplicate payment was made for the same order.</li>
              </ul>
              <p className="text-sm text-gray-700 mt-3">All refund requests are reviewed within 10 business days. Approved refunds are processed through TrueAutoCheck to the original payment method.</p>
            </div> */}
          </section>
